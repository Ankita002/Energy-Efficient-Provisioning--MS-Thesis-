...
import org.cloudbus.cloudsim.HostStabilityFactor;
...
public class Host {
	...
	public static HostStabilityFactor hsf;
	/**
	...
	public Host(int id,
		...
		hsf = new HostStabilityFactor(vmScheduler, ramProvisioner, bwProvisioner, null);
		setPeList(peList);
...
//			}
	...
	/*	if (getBw() < vm.getBw() || getRam() < vm.getCurrentRequestedRam()) {
			return false;
		}
		return true;
	*/
